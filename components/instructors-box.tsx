        ...
        <div className="flex justify-between items-start gap-12">
          ...
          <div className="space-y-4">
            ...
            <h3 className="text-4xl font-bold leading-tight">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#6630C6] to-[#330F95]">
                Instructors
              </span>
            </h3>
          </div>
          ...
          <div className="flex items-center">
            <p className="text-[#CCCCCC] leading-relaxed max-w-xs">
              ...
              teaching and committed to helping you grow.
            </p>
          </div>
        </div>
          ...
          {instructors.map((instructor, index) => (
            <div key={index} className="relative">
              ...
              <div className="rounded-[40px] overflow-hidden">
                ...
                <div className="w-full h-80 bg-[#C4C4C4] rounded-[40px] mb-4"></div>
                ...
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, #6630C6 0%, #330F95 100%)",
                  }}
                >
